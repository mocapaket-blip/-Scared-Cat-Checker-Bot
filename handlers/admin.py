...
EXISTING_TEXT = (
    ...
    "У вас есть ровно 7 дней на верификацию (до 11.05.2026).\n"
    "Кто не пройдёт — потеряет возможность писать сообщения.\n"
...
async def cmd_start_verification_existing(message: Message, bot: Bot) -> None:
    """
    Публикует и закрепляет сообщение в группе для уже состоящих участников.
    """
    me = await bot.get_me()
